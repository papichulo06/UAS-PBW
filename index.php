...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
      <div class="container">
        <a class="navbar-brand fw-bold" href="#">Pendataan Buku di Perpustakaan</a>
        <button
    ...
    <section id="hero" class="hero text-center py-5">
      <div class="container">
        <h1 class="display-4 fw-bold">Pengertian Perpustakaan</h1>
        <p class="lead">Perpustakaan adalah tempat yang menyimpan dan mengelola berbagai jenis koleksi bahan pustaka, seperti buku, majalah, dan jurnal. Selain itu, perpustakaan juga berfungsi sebagai sumber informasi untuk ilmu pengetahuan, hiburan, dan rekreasi. Pengertian Perpustakaan

Perpustakaan adalah institusi yang mengumpulkan, mengelola, dan menyediakan akses terhadap bahan pustaka dan informasi untuk kepentingan pembelajaran, penelitian, dan pengembangan masyarakat.
Dalam arti tradisional, perpustakaan dikenal sebagai koleksi buku dan majalah, tetapi kini juga mencakup berbagai media seperti CD, DVD, dan akses internet.
Perpustakaan berfungsi untuk memenuhi kebutuhan intelektualitas penggunanya melalui interaksi pengetahuan.</p>
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="img/pp.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/ooop.jpg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
